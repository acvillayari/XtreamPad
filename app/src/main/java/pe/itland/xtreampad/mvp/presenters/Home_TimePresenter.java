...
public class Home_TimePresenter implements Home_TimeContrato.Presenter {

    private WeakReference<Home_TimeContrato.View> view;


    private  Home_PrincipalRepositorio home_principalrepositorio;

    @Inject
    public Home_TimePresenter(Home_PrincipalRepositorio home_PrincipalRepositorio) {
    ...
    @Override
    public void attachView(Home_TimeContrato.View view) {
