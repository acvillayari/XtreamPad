...
public class Home_PrincipalPresenter implements Home_PrincipalContrato.Presenter {

    private WeakReference<Home_PrincipalContrato.View> view;


    private  Home_PrincipalRepositorio home_principalrepositorio;

    @Inject
    public Home_PrincipalPresenter(Home_PrincipalRepositorio home_PrincipalRepositorio) {
    ...
    @Override
    public void attachView(Home_PrincipalContrato.View view) {
