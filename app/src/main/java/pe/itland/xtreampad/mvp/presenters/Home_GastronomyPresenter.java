...
public class Home_GastronomyPresenter implements Home_GastronomyContrato.Presenter {

    private WeakReference<Home_GastronomyContrato.View> view;


    private  Home_PrincipalRepositorio home_principalrepositorio;

    @Inject
    public Home_GastronomyPresenter(Home_PrincipalRepositorio home_PrincipalRepositorio) {
    ...
    @Override
    public void attachView(Home_GastronomyContrato.View view) {
