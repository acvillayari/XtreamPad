...
public class FooterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_footer, container, false);

        video_bannerHome = root.findViewById(R.id.video_bannerHome);
        String videopath ="android.resource://" + root.getContext().getPackageName() + "/" + R.raw.videococacola;
